...
class AddressRepository:
    ...
    @staticmethod
    async def get_duplicate_address(session: AsyncSession, address_data: dict, user_id: int):
        stmt = select(Address).where(
            ...
            Address.address_neighborhood == address_data["address_neighborhood"],
            Address.address_street == address_data["address_street"],
            Address.address_number == address_data["address_number"],
            Address.address_complement == address_data.get("address_complement"),
        )
